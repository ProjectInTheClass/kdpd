...
class RandomViewController: UIViewController, UIDocumentInteractionControllerDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        replayButton.layer.borderWidth = 0.5
        //replayButton.layer.borderColor = (UIColor.orange as! CGColor)
        ...
        if ForRec[num].photo1 == "x" {
            ...
            imageView.pin_setImage(from: URL(string: "\(ForRec[num].photo1)"))
        }
